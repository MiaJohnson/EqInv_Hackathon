...
@dso_cache = dso_local local_unnamed_addr global [598 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 115713944, ; hash 0x6e5a798, from name: MetroLog.Net6
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 513826910, ; hash 0x1ea0605e, from name: aot-MetroLog.Net6
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-MetroLog.Net6.dll.so
		ptr null; void* handle (0x0)
	}, ; 63
	...
	%struct.DSOCacheEntry {
		i64 602426475, ; hash 0x23e84c6b, from name: aot-MetroLog.Maui.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 690561004, ; hash 0x29291fec, from name: libaot-MetroLog.Maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-MetroLog.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 88
	...
	%struct.DSOCacheEntry {
		i64 802557335, ; hash 0x2fd60d97, from name: libaot-MetroLog.Net6
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-MetroLog.Net6.dll.so
		ptr null; void* handle (0x0)
	}, ; 101
	...
	%struct.DSOCacheEntry {
		i64 815124059, ; hash 0x3095ce5b, from name: MetroLog.Maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-MetroLog.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 103
	...
	%struct.DSOCacheEntry {
		i64 1144617715, ; hash 0x44397af3, from name: aot-MetroLog.Net6.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-MetroLog.Net6.dll.so
		ptr null; void* handle (0x0)
	}, ; 146
	...
	%struct.DSOCacheEntry {
		i64 1463216827, ; hash 0x5736eabb, from name: libaot-EqInv
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1579481597, ; hash 0x5e24f9fd, from name: aot-EqInv.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EqInv.dll.so
		ptr null; void* handle (0x0)
	}, ; 205
	...
	%struct.DSOCacheEntry {
		i64 1856490000, ; hash 0x6ea7ca10, from name: libaot-MetroLog.Maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-MetroLog.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 240
	...
	%struct.DSOCacheEntry {
		i64 2054087388, ; hash 0x7a6ee2dc, from name: aot-EqInv
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EqInv.dll.so
		ptr null; void* handle (0x0)
	}, ; 277
	...
	%struct.DSOCacheEntry {
		i64 2615069709, ; hash 0x9bdecc0d, from name: MetroLog.Maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-MetroLog.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 361
	...
	%struct.DSOCacheEntry {
		i64 2646093790, ; hash 0x9db82fde, from name: MetroLog.Net6.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-MetroLog.Net6.dll.so
		ptr null; void* handle (0x0)
	}, ; 365
	...
	%struct.DSOCacheEntry {
		i64 2729293469, ; hash 0xa2adb69d, from name: EqInv.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EqInv.dll.so
		ptr null; void* handle (0x0)
	}, ; 379
	...
	%struct.DSOCacheEntry {
		i64 2820647746, ; hash 0xa81fab42, from name: EqInv
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EqInv.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
	...
	%struct.DSOCacheEntry {
		i64 2995555453, ; hash 0xb28c8c7d, from name: libaot-EqInv.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EqInv.dll.so
		ptr null; void* handle (0x0)
	}, ; 423
	...
	%struct.DSOCacheEntry {
		i64 3214757650, ; hash 0xbf9d4f12, from name: libaot-MetroLog.Net6.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-MetroLog.Net6.dll.so
		ptr null; void* handle (0x0)
	}, ; 457
	...
	%struct.DSOCacheEntry {
		i64 4273314105, ; hash 0xfeb59939, from name: aot-MetroLog.Maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-MetroLog.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 592
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [129 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
